...
const questions = [
  ...
  {
    question: "¿Cuanto es 12 x 10 x 0",
    optionA: "12",
    optionB: "120",
    optionC: "1",
    optionD: "0",
...
function handleEndGame() {
  ...
  winners.push({ "User": actualUser, "Score": playerScore })
  console.log("Texto podio: " + getPodium())
}
...
function openPodiumModal() {
  ...
  document.getElementById("podium").innerHTML = getPodium()
...
function getPodium() {
  if (!winners.length) {
    ...
    return "Todavía no ha ganado ningún jugador."
  }
  // Selecciona al jugador con mayor puntaje dentro del array de podium y prepara el texto
  let maxObj = winners.reduce((max, obj) => (max.Score > obj.Score) ? max : obj);
  return "Usuario: " + maxObj.User + "<br> u$s: " + maxObj.Score
}
